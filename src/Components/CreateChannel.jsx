    ...
    return (
        <>
            <section className="channlePage w-screen h-auto pb-12 flex justify-center">
                <div className="w-4/5 h-auto mb-12 pb-12 bg-slate-200 flex flex-col items-center justify-start pt-7 gap-12">
                    ...
                    <div className="bg-white w-4/5 h-auto py-2 flex flex-col gap-4">
                        <div className="border-2 px-3 py-2 mx-2 lg:mx-12 rounded-xl">
                    ...
                    <div className="w-full px-7 flex justify-end items-center gap-7 py-2">
                        <button className="px-2 py-1 bg-white rounded-lg">Cancel</button>
                        <button onClick={channel} className="px-2 py-1 bg-white rounded-lg">Create Channel</button>
                        <button onClick={viewChannel} className="px-2 py-1 bg-white rounded-lg hover:bg-slate-300">View Channel</button>
                    </div>
                </div>
            </section>
        </>
